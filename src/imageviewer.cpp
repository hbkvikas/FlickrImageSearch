...
ImageViewer::ImageViewer(QWidget *parent) : QAbstractScrollArea(parent) {
    ...
    m_hideButton = new QPushButton("Hide Me", this);
    m_hideButton->setSizePolicy(QSizePolicy::Fixed, QSizePolicy::Fixed);

    auto *layout = new QGridLayout(this);
    layout->setContentsMargins(0, 0, 0, 0);
    layout->setMargin(0);
    layout->setSpacing(0);
    layout->addWidget(m_hideButton, 0, 1);
    ...
    connect(m_hideButton, &QPushButton::clicked, this, hideImageViewer);
...
void ImageViewer::hideImageViewer(bool isHidden)
{
    this->setHidden(true);
}
